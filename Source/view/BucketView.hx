...
class BucketView extends Sprite {
...
// the floor it will begin rolling towards the tower.
    CryptoBody.createLitecoinBody().space = space;
    CryptoBody.createLitecoinBody().space = space;
...
// Step forward in simulation by the required number of seconds.
        ...
        for(body in space.bodies){
            if(body.userData.graphic != null){
                ...
                body.userData.graphic.rotation = body.rotation * (360/(2*Math.PI));
            }
        }
